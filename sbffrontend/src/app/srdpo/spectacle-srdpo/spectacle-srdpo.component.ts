...
@Component({
  selector: 'app-spectacle-srdpo',
  standalone: true,
  imports: [FormsModule,ToastModule,DialogModule,CommonModule],
  providers: [MessageService],
  templateUrl: './spectacle-srdpo.component.html',
  styleUrl: './spectacle-srdpo.component.css'
})
export class SpectacleSrdpoComponent {
