...
@Component({
  selector: 'app-physicallchallenged-list',
  standalone: true,
  imports: [ToastModule,DialogModule,CommonModule,FormsModule],
  providers: [MessageService],
  templateUrl: './physicallchallenged-list.component.html',
  styleUrl: './physicallchallenged-list.component.css'
})
export class PhysicallchallengedListComponent {
