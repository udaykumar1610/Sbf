...
@Component({
  selector: 'app-physically-challenged-div',
  standalone: true,
  imports: [ToastModule,FormsModule,CommonModule,DialogModule],
  providers: [MessageService],
  templateUrl: './physically-challenged-div.component.html',
  styleUrl: './physically-challenged-div.component.css'
})
export class PhysicallyChallengedDivComponent {
